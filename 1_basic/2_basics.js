...
anyVar = 10;
anyVar = true;
let testNumber = anyVar; // anyVar가 number라고 타입을 지정해도 에러가 나지 않음
...
let unknownType2 = unknownType; // unknown 타입에 unknown 타입을 할당 가능
let anyType2 = unknownType; // unknown 타입에 any 타입을 할당 가능
